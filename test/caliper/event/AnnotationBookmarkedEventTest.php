...
class AnnotationBookmarkedEventTest extends PHPUnit_Framework_TestCase {
	private $testObject;
	...
	function testObjectSerializesToJson() {
		...
		$testFixtureFilePath = realpath(CALIPER_LIB_PATH . '/../../caliper-common-fixtures/src/test/resources/fixtures/caliperBookmarkAnnotationEvent.json');
