 ...
 * @requires PHP 5.4
 */
class AnnotationSharedEventTest extends PHPUnit_Framework_TestCase {
	private $testObject;
	...
	function testObjectSerializesToJson() {
		...
		$testFixtureFilePath = realpath(CALIPER_LIB_PATH . '/../../caliper-common-fixtures/src/test/resources/fixtures/caliperSharedAnnotationEvent.json');
